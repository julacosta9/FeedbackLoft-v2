...
const EmptyProject = () => {
    ...
    return (
        <div>
        {showForm === false ?
        (<div onClick={() => setFormState(true) } className="flex flex-col lg:w-4/12 max-w-sm items-center my-2 p-8 rounded bg-fl-black space-x-2 mx-auto cursor-pointer hover:shadow-md transition ease-in-out duration-200">
