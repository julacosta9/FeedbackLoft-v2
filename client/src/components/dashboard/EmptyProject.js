...
const EmptyProject = () => {
    ...
    return (
        <div>
        {showForm === false ?
        (<div onClick={() => setFormState(true) } className="flex flex-col items-center my-2 p-8 rounded bg-fl-yellow space-x-2 w-1/4 mx-auto cursor-pointer hover:shadow-md transition ease-in-out duration-200">
